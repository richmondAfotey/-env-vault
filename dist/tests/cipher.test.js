...
import { MAGIC, decryptVault, encryptVault, } from '../src/crypto/cipher.js';
...
test('throws PasswordError on data that is not a vault', () => {
    assert.throws(() => decryptVault(Buffer.from('definitely not an env-vault blob'), 'pw'), PasswordError);
});
