...
export const HEADER_BYTES = Buffer.byteLength(MAGIC) + 1 + 1 + 4 + SALT_BYTES + IV_BYTES;
 ...
 */
export function encryptVault(profile, password, iterations = DEFAULT_ITERATIONS) {
 ...
 */
export function decryptVault(data, password) {
